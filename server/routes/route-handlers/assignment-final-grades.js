...
exports.get = function (req, res) {
    ...
    req.App.api.post('/getAssignmentGrades/' + req.params.ai_id, function (err, statusCode, body) {
        var userList = [];
        var ai = '';
        var userTaskList = [];
        ...
        //student loop
        for (var i = 0; i < body.SectionUsers.length; i++) {
            if (body.SectionUsers[i] == req.App.user.userId) for (var w = 0; w < body.SectionUsers[i].assignmentGrade.WorkflowActivityGrades.length; w++) {
