...
var Parser = function () {
  ...
  (0, _createClass3.default)(Parser, [{
    key: 'applyFilters',
    value: function applyFilters(attribute, value) {
    ...
    value: function applyMatchers(string, parentConfig) {
      ...
      while (parts = matchedString.match(/#\{\{(\d+)\}\}#/)) {
        var _parts2 = parts,
            _parts3 = (0, _slicedToArray3.default)(_parts2, 2),
            no = _parts3[1];
    ...
    value: function extractAttributes(node) {
      ...
      (0, _from2.default)(node.attributes).forEach(function (attr) {
        ...
        if (name.substr(0, ARIA_COMPARE_LENGTH) !== 'aria-') {
          if (!disableWhitelist && (!filter || filter === _constants.FILTER_DENY) || name.match(/^on/) || value.replace(/(\s|\0|&#x0(9|A|D);)/, '').match(/(javascript|vbscript|livescript|xss):/i)) {
            return;
          }
        }

        value = _this2.applyFilters(name, value);
        ...
        attributes[_constants.ATTRIBUTES_TO_PROPS[name] || name] = value;
        count += 1;
      });
    ...
    value: function getTagConfig(tagName) {
      if (_constants.TAGS[tagName]) {
        return (0, _extends3.default)({}, _constants.TAGS[tagName], {
          tagName: tagName
        });
      }
    ...
    value: function parse() {
      return this.parseNode(this.doc.body, (0, _extends3.default)({}, _constants.CONFIG_BLOCK, {
        tagName: 'body'
      }));
    }
  }, {
      ...
      (0, _from2.default)(parentNode.childNodes).forEach(function (node) {
        if (node.nodeType === ELEMENT_NODE) {
          ...
          if (!(noHtml || noHtmlExceptMatchers) && (disableWhitelist || _this3.canRenderChild(parentConfig, config))) {
            ...
            content = content.concat(_this3.parseNode(node, config.tagName ? config : parentConfig));
          }
