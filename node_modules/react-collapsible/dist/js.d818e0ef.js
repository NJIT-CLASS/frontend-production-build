...
},{"./factoryWithTypeCheckers":"../node_modules/prop-types/factoryWithTypeCheckers.js"}],"../src/Collapsible.js":[function(require,module,exports) {
"use strict";
...
function (_Component) {
  ...
  function Collapsible(props) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(Collapsible).call(this, props)); // Defaults the dropdown to be closed

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "continueOpenCollapsible", function () {
      _this.setState({
        height: _this.innerRef.scrollHeight,
        transition: "height ".concat(_this.props.transitionTime, "ms ").concat(_this.props.easing),
        isClosed: false,
        hasBeenOpened: true,
        inTransition: true,
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleTriggerClick", function (event) {
      event.preventDefault();
    ...
    if (props.open) {
      ...
      _this.state = {
        ...
        shouldSwitchAutoOnNextCycle: false,
        height: 0,
        transition: "height ".concat(props.transitionTime, "ms ").concat(props.easing),
        hasBeenOpened: false,
        overflow: 'hidden',
        inTransition: false
      };
  ...
  _createClass(Collapsible, [{
    ...
    value: function render() {
      ...
      var trigger = this.state.isClosed === false && this.props.triggerWhenOpen !== undefined ? this.props.triggerWhenOpen : this.props.trigger; // If user wants a trigger wrapping element different than 'span'
      ...
      var openedClassName = this.props.classNameOpen;
      var closedClassName = this.props.classNameClosed; // Construct CSS classes strings

      var triggerClassString = "".concat(this.props.classParentString, "__trigger ").concat(toggleClassName, " ").concat(disabledClass, " ").concat(this.state.isClosed ? this.props.triggerClassName : this.props.triggerOpenedClassName);
      var outerClassString = "".concat(this.props.classParentString, "__contentOuter ").concat(this.props.contentOuterClassName);
      var innerClassString = "".concat(this.props.classParentString, "__contentInner ").concat(this.props.contentInnerClassName);
      return _react.default.createElement("div", {
        className: "".concat(this.props.classParentString, " ").concat(className, " ").concat(this.state.isClosed ? closedClassName : openedClassName)
...
var _Collapsible = _interopRequireDefault(require("../../../src/Collapsible"));

require("../sass/main.scss");

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var triggerSiblingExample = function triggerSiblingExample() {
  return _react.default.createElement("div", {
    className: "Collapsible__custom-sibling"
  }, "This is a sibling to the trigger which wont cause the Collapsible to open!");
};

var App = function App() {
  return _react.default.createElement("div", null, _react.default.createElement(_Collapsible.default, {
    className: "classNameDefault",
    classNameOpen: "classNameOpen",
    classNameClosed: "classNameClosed",
    tabIndex: 0,
    trigger: "Start here"
  }, _react.default.createElement("p", null, "This is the collapsible content. It can be any element or React component you like."), _react.default.createElement("p", null, "It can even be another Collapsible component. Check out the next section!")), _react.default.createElement(_Collapsible.default, {
    transitionTime: 400,
    trigger: "Then try this one"
  }, _react.default.createElement("p", null, "Would you look at that!"), _react.default.createElement("p", null, "See; you can nest as many Collapsible components as you like."), _react.default.createElement(_Collapsible.default, {
    trigger: "Mmmmm, it's all cosy nested here"
  }, _react.default.createElement("p", null, "And there's no limit to how many levels deep you go. Or how many you have on the same level."), _react.default.createElement(_Collapsible.default, {
    trigger: "This is just another Collapsible"
  }, _react.default.createElement("p", null, "It just keeps going and going! Well, actually we've stopped here. But that's only because I'm running out of things to type.")), _react.default.createElement(_Collapsible.default, {
    trigger: "But this one is open by default!",
    open: true
  }, _react.default.createElement("p", null, "And would you look at that! This one is open by default. Sexy huh!?"), _react.default.createElement("p", null, "You can pass the prop of open={true} which will make the Collapsible open by default.")), _react.default.createElement(_Collapsible.default, {
    trigger: "That's not all. Check out the speed of this one",
    transitionTime: 100
  }, _react.default.createElement("p", null, "Whoosh! That was fast right?"), _react.default.createElement("p", null, "You can control the time it takes to animate (transition) by passing the prop transitionTime a value in milliseconds. This one was set to transitionTime={100}")))), _react.default.createElement(_Collapsible.default, {
    transitionTime: 400,
    trigger: "This one will blow your mind.",
    easing: 'cubic-bezier(0.175, 0.885, 0.32, 2.275)'
  }, _react.default.createElement("p", null, "Well maybe not. But did you see that little wiggle at the end. That is using a CSS cubic-beizer for the easing!"), _react.default.createElement("p", null, "You can pass any string into the prop easing that you would declare in a CSS transition-timing-function. This means you have complete control over how that Collapsible appears.")), _react.default.createElement(_Collapsible.default, {
    transitionTime: 400,
    trigger: "Oh and did I mention that I'm responsive?",
    triggerWhenOpen: "Plus you can change the trigger text when I'm open too"
  }, _react.default.createElement("p", null, "That's correct. This collapsible section will animate to the height it needs to and then set it's height back to auto."), _react.default.createElement("p", null, "This means that no matter what width you stretch that viewport to, the Collapsible it will respond to it."), _react.default.createElement("p", null, "And no matter what height the content within it is, it will change height too."), _react.default.createElement("h2", null, "CSS Styles"), _react.default.createElement("p", null, "All of the style of the Collapsible (apart from the overflow and transition) are controlled by your own CSS too."), _react.default.createElement("p", null, "By default the top-level CSS class is Collapsible, but you have control over this too so you can easily add it into your own project. Neato!"), _react.default.createElement("p", null, "So by setting the prop of classParentString={\"MyNamespacedClass\"} then the top-level class will become MyNamespacedClass.")), _react.default.createElement(_Collapsible.default, {
    lazyRender: true,
    transitionTime: 600,
    trigger: "What happens if there's a shed-load of content?",
    easing: 'cubic-bezier(0.175, 0.885, 0.32, 2.275)',
    overflowWhenOpen: "visible"
  }, _react.default.createElement("p", null, "Add the prop of ", _react.default.createElement("strong", {
    style: {
      fontWeight: 'bold'
    }
  }, "lazyRender"), " and the content will only be rendered when the trigger is pressed"), _react.default.createElement("img", {
    src: "https://lorempixel.com/320/240?random=1"
  }), _react.default.createElement("img", {
    src: "https://lorempixel.com/320/240?random=2"
  }), _react.default.createElement("img", {
    src: "https://lorempixel.com/320/240?random=3"
  }), _react.default.createElement("img", {
    src: "https://lorempixel.com/320/240?random=4"
  }), _react.default.createElement("img", {
    src: "https://lorempixel.com/320/240?random=5"
  }), _react.default.createElement("img", {
    src: "https://lorempixel.com/320/240?random=6"
  })), _react.default.createElement(_Collapsible.default, {
    trigger: "You can set a custom trigger tag name.",
    triggerTagName: "div"
  }, _react.default.createElement("p", null, "Use the ", _react.default.createElement("code", null, "`triggerTagName`"), " prop to set the trigger wrapping element."), _react.default.createElement("p", null, "Defaults to ", _react.default.createElement("code", null, "span"), ".")), _react.default.createElement(_Collapsible.default, {
  ...
  }, _react.default.createElement("p", null, "This is the collapsible content. It can be any element or React component you like.")), _react.default.createElement(_Collapsible.default, {
    trigger: "You can disable them programatically too",
    open: true,
    triggerDisabled: true
  }, _react.default.createElement("p", null, "This one has it's trigger disabled in the open position. Nifty."), _react.default.createElement("p", null, "You also get the ", _react.default.createElement("strong", null, "is-disabled"), " CSS class so you can style it.")), _react.default.createElement(_Collapsible.default, {
  ...
  }, _react.default.createElement("p", null, "Adds a ", _react.default.createElement("code", null, "style"), " attribute to the ", _react.default.createElement("code", null, "span"), " trigger.")));
};

_reactDom.default.render(_react.default.createElement(App, null), document.querySelector('#root'));
},{"react":"../node_modules/react/index.js","react-dom":"../node_modules/react-dom/index.js","../../../src/Collapsible":"../src/Collapsible.js","../sass/main.scss":"src/sass/main.scss"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
